...
- (NSString *)executable {
    NSString* path = [[NSBundle bundleForClass:self.class] pathForResource:@"image_decoder" ofType:nil];
...
- (NSString *)sandbox {
    ...
    NSString *sandboxFileName = [[bundle pathForResource:@"image_decoder" ofType:@"sb"] stringByResolvingSymlinksInPath];
    ...
    NSDictionary *subs = @{
        @"@PATH_TO_IMAGE_DECODER_EXECUTABLE@": executable.stringByEscapingForSandboxLiteral
    };
...
//    NSString* TEMP = [lines componentsJoinedByString:@"\n"];
//    [TEMP writeToFile:@"~/Downloads/sb.sb".stringByExpandingTildeInPath atomically:YES encoding:NSUTF8StringEncoding error:nil];
