...
- (NSString *)applicationSupportDirectory {
    // iTermLib Edit: Replace kCFBundleExecutableKey with kCFBundleIdentifierKey
    NSString *executableName =
        [[[NSBundle mainBundle] infoDictionary] objectForKey:(id)/* kCFBundleExecutableKey */ kCFBundleIdentifierKey];
    NSError *error;
