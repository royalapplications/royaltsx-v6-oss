...
@implementation ITPSMOverflowPopUpButton
...
- (id)initWithFrame:(NSRect)frameRect pullsDown:(BOOL)flag
{
    self = [super initWithFrame:frameRect pullsDown:YES];
        ...
        _PSMTabBarOverflowPopUpImage = [[NSImage alloc] initByReferencingFile:[[ITPSMTabBarControl bundle] pathForImageResource:@"overflowImage"]];
                _PSMTabBarOverflowDownPopUpImage = [[NSImage alloc] initByReferencingFile:[[ITPSMTabBarControl bundle] pathForImageResource:@"overflowImagePressed"]];
