...
@protocol ITPSMMinimalProgressIndicatorInterface <NSObject>
...
@implementation ITPSMProgressIndicator {
...
- (id<ITPSMMinimalProgressIndicatorInterface>)currentIndicator {
    if (self.light) {
        return (id<ITPSMMinimalProgressIndicatorInterface>)_lightIndicator;
    } else {
        return (id<ITPSMMinimalProgressIndicatorInterface>)_darkIndicator;
    }
}
