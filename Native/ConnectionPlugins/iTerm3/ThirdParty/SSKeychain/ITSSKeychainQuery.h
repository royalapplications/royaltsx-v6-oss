...
#define ITSSKeychain_SYNCHRONIZATION_AVAILABLE 0

#ifdef ITSSKeychain_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, ITITSSKeychainQuerySynchronizationMode) {
	ITITSSKeychainQuerySynchronizationModeAny,
	ITITSSKeychainQuerySynchronizationModeNo,
	ITITSSKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface ITITSSKeychainQuery : NSObject
...
@property (nonatomic) ITITSSKeychainQuerySynchronizationMode synchronizationMode;
#endif
...
/**
 ...
 ITSSKeychain_SYNCHRONIZATION_AVAILABLE is only for compile time. If you are checking for the presence of synchronization,
