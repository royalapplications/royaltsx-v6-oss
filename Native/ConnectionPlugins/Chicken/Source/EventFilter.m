...
- (void)scrollWheel: (NSEvent *)theEvent
{
	...
	NSPoint mouseLocation = [_view.window convertPointFromScreen:NSEvent.mouseLocation];
	
    NSPoint	p = [_view convertPoint:mouseLocation fromView:nil];
...
- (void)flagsChanged:(NSEvent *)theEvent
{
    ...
    [self queueModifiers:(unsigned)theEvent.modifierFlags
...
- (void)queueKeyEventFromEvent: (NSEvent *)theEvent
{
    ...
    unsigned int modifiers = (unsigned)theEvent.modifierFlags;
