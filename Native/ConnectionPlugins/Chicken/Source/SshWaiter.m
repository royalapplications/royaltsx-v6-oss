...
- (void)firstTimeConnecting:(NSString *)fingerprint
{
	...
	alert.messageText = ChickenVncFrameworkLocalizedString(@"FirstTimeHeader", nil);
	alert.informativeText = [NSString stringWithFormat:msg, fingerprint];
	...
	__weak SshWaiter* weakSelf = self;
	
	[alert beginSheetModalForWindow:window completionHandler:^(NSModalResponse returnCode) {
		[weakSelf firstTime:alert returnCode:returnCode contextInfo:nil];
	}];
}

- (void)firstTime:(NSAlert*)sheet
